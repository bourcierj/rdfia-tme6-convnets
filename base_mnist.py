...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/tmp/datasets/mnist', type=str,
    ...
    parser.add_argument('--lr', default=0.1, type=float, metavar='LR',
                        help='learning rate')
    parser.add_argument('--savefig-path', default='./', type=str, metavar='DIR',
...
# Results (5 epochs)
# TRAIN: Avg loss 0.0515 Avg Prec@1 98.47 %  Avg Prec@5 99.98 %
# EVAL: Avg loss 0.0411 Avg Prec@1 98.62 %  Avg Prec@5 100.00 %
